...
const MainEventBus = new _MainEventBus('prod');
function busTrigger(componentName,eventName,data){
	return MainEventBus.trigger(componentName,eventName,data);
}

window['bus'] = MainEventBus;
export { MainEventBus, busTrigger };
