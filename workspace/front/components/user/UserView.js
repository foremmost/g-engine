...
export class UserView extends View{
    	...
    	return  _.el('USER-ACTION',{
		    childes:[
			    _.el('USER-LOGO',{
				    childes:[
					    _.el('IMG',{
						   src:'/workspace/img/g.svg'
					    })
				    ]
			    }),
			   /* _.el('BUTTON',{class:'user-more-play','data-click-action':`${_.componentName}:showMoreInfo`,
				    childes:[
					    _.el('IMG',{src:'/workspace/img/play.svg'})
				    ]}
			    ),
			    _.el('BUTTON',{class:'user-more-btn','data-click-action':`${_.componentName}:showMoreInfo`,
				    childes:[
    ...
    userHeadTpl(userNameResponse){
    	const _ = this;
    	let hello,hours = new Date().getHours();
    	if((hours >= 4) && (hours < 12) ){
		    hello = 'Good Morning,'
